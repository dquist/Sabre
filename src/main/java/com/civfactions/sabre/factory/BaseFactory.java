...
import com.civfactions.sabre.factory.recipe.IRecipe;
...
public class BaseFactory extends SpecialBlock {
	...
	public BaseFactory(Location location, String typeName) {
		...
		fuels.add(new FactoryFuel(new SabreItemStack(Material.COAL, "Coal", 1, 0), 2));
		fuels.add(new FactoryFuel(new SabreItemStack(Material.BLAZE_ROD, "Blaze Rod", 1), 8));
