package com.civfactions.sabre.bastion;
...
public class KeepBastion extends SpecialBlock {
	
	public static final String blockName = "Keep Bastion";
	
	private final int BREAK_MULTIPLIER = 100;
	
	protected int counter;
	
	public KeepBastion(Location location, String typeName) {
