...
public class ResourceBastion extends SpecialBlock {
	
	public static final String blockName = "Resource Bastion";
	
	private final int BREAK_MULTIPLIER = 10;
	
	protected int counter;
	
	public ResourceBastion(Location location, String typeName) {
