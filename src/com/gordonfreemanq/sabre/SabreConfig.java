...
public class SabreConfig {
	...
	public void read() {		
		...
		this.farmProximity = fc.getInt("farm.proximity", 500);
		this.farmChunkRadius = fc.getInt("farm.chunk_radius", 3);
		this.farmSurveySampleSize = fc.getInt("farm.survey_sample_size", 20);
